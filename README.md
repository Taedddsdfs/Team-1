...
-**Fix**: Always execute commands from inside the repo/tb/ directory.3. Linker Error: "undefined reference to ticks"Cause: The C++ testbench is missing the global tick counter definition required by the header file.Fix: Add unsigned int ticks = 0; at the top of your .cpp testbench file.
